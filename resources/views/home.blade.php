...
<body>
    ...
    <header id="header" class="header d-flex align-items-center">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="/" class="logo d-flex align-items-center">
                <img src="assets/img/veidi.png" alt="">
            </a>
    ...
    <section id="hero" class="hero">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a data-aos="fade-up" data-aos-delay="200" href="img/app/cliente-nova.apk" class="btn-get-started"><img
        ...
        <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-item"
                style="background-image: url(assets/img/hero-carousel/vista-lateral-hombre-que-maneja-sofa-mientras-prepara-mudarse.jpg)">
            </div>
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row position-relative">
                    ...
                    <div class="col-lg-7 about-img shadow"
...
--->
        <div class="footer-legal text-center position-relative">
            <div class="container">
                <div class="copyright">
                    &copy; Copyright <strong>Veidi</strong>. All Rights Reserved
                </div>
            </div>
        </div>
